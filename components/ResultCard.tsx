  ...
  return (
    <div className="animate-pop-in" style={{
      ...
      <div style={{ padding: "16px 20px 0", display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center" }}>
        {[
          { icon: "🏷️", text: restaurant.category, bg: darkMode ? "#3a1f08" : "#fff5e6", color: "#c05c00" },
          { icon: "⭐", text: `${restaurant.rating}`, bg: darkMode ? "#3a2e08" : "#fffbe6", color: "#b07000" },
      ...
      <div style={{ padding: "16px 20px 12px", display: "flex", gap: 10 }}>
        <button
          ...
          style={{
            ...
            background: darkMode ? "#3a1508" : "#fff",
            color: "#E63946",
            fontWeight: 800,
            fontSize: 14,
            borderRadius: 16,
          ...
          onMouseEnter={e => {
            (e.currentTarget as HTMLElement).style.background = darkMode ? "#4a1f0a" : "#fff5f5";
            (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.background = darkMode ? "#3a1508" : "#fff";
      ...
      <div style={{ padding: "0 20px 20px" }}>
        <a
          ...
          style={{
            ...
            fontSize: 13,
            textDecoration: "none",
            background: darkMode ? "#2a1508" : "#fff",
            transition: "all 0.18s",
            boxSizing: "border-box",
          }}
          onMouseEnter={e => {
            (e.currentTarget as HTMLElement).style.background = darkMode ? "#351a08" : "#fff5e6";
            (e.currentTarget as HTMLElement).style.transform = "translateY(-1px)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.background = darkMode ? "#2a1508" : "#fff";
            (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
          }}
        >
